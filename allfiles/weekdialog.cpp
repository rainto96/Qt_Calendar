...
WeekDialog::WeekDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::WeekDialog)
{
    ui->setupUi(this);
    AllDates=new Date[99];
    FileIO::readFromFile(AllDates,"/home/rainto96/THISISMY/mem/mes.dat",99);
...
void WeekDialog::setBeautiful()
{
    ...
    int width=100*1.5;int height=62*1.5;
    for(int i=0;i<=6;i++)
